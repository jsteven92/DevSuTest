...
public class MovementEntity {
	...
	public Movement toDomainModel() {
		...
		return new Movement(movementId, dateString, type, amount, balance, null);
	}
	...
	public static MovementEntity fromDomainModel(Movement movement) {
		...
		AccountEntity account = AccountEntity.fromDomainModel(movement.getAccount());
		return new MovementEntity(movement.getMovementId(), movementDate, movement.getType(), movement.getAmount(),
				movement.getBalance(), account);
	}
}
