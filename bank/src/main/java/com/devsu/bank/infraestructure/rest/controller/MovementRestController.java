...
public class MovementRestController {
	...
	public ResponseEntity<List<Movement>> getMovementByAccountId(@PathVariable Long accountId){
		return new ResponseEntity<>( movementInterator.findMovementByAccountId(accountId), HttpStatus.OK);
	}
}
